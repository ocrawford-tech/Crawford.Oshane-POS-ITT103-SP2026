    ...
    try:
        ...
        for product in products:
            ...
            if code == product[0]:
                ...
                # This block of code test for stock availability before anything is added to cart.
...
def remove_from_cart():
    try:
        ...
        # This function allows a loop through the cart using the variable "item", to find the code that was inputted by the user.
        for item in cart:
...
def view_cart():
    ...
    for item in cart:
        ...
        # This formula allows the price to be calculated for each type of item by multiplying price by quantity.
        item_total = price * quantity

        # This function allows the subtotal total price to be calculated by adding all "item totals".
        total += item_total
...
def checkout():
    ...
    for item in cart:
        ...
        # This is the multiplication positional index for price * quantity to get subtotal
        ...
        for item in cart:
            ...
            for product in products:
                ...
                if product[0] == code:
                    ...
                    # When we minus what we have from what was bought, we will be left with an updated stock of items.
                    product[3] -= quantity
